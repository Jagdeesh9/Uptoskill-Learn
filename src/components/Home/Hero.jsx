...
function Hero() {
  return (
    <div className='p-20 bg-gray-900 text-white flex items-center justify-center flex-col font-sans' id="hero">
        ...
        <div className='w-full flex items-center justify-center'><i></i><button className='py-2 w-full md:w-96 lg:w-96 lg:px-10 p-6 bg-green-500 rounded-sm font-bold mt-10'>Log In with google </button></div>
